...
myUUIDLs = ['F000AA82-0451-4000-B000-000000000000','F000AA83-0451-4000-B000-000000000000',
...
class BleTestApp(App):
    ...
    def connect_to_tag(self):
        ...
        print ble_central.devices
        for d in ble_central.devices:
            print ble_central.devices[d]
            print ble_central.devices[d].name
            if 'SensorTag' in ble_central.devices[d].name:
                print 'found sensorTag...'
                ble_central.devices[d].connect()
                print 'servicesMJR: ', ble_central.devices[d].services
                # ble_central.devices[d].discover_services(uuids=myUUIDLs)
                ble_central.devices[d].discover_services(uuids=None)
                # peripheral.services
                print 'servicesMJR2: ', ble_central.devices[d].services
                print 'connected!!!!!!!'
            # if 'BOOM' in ble_central.devices[d].name:
            #     print 'found BOOOM...'
            #     ble_central.devices[d].connect()
            #     print 'servicesMJR: ', ble_central.devices[d].services
            #     # ble_central.devices[d].discover_services(uuids=['3edaf20a-df44-4586-8c32-75f09fced9b8'])
            #     print 'servicesMJR2: ', ble_central.devices[d].services
            #     print 'connected!!!!!!!'

        # ble_central.connect('3edaf20a-df44-4586-8c32-75f09fced9b8')
